...
%    
    ...
    if nt ~= nt_ht
      error('dhdt_v3_qin_qout: rain length is %d. ht length is %d. They should be the same.', nt, nt_ht);
    end 
    ...
    w_out_full = lambda * sqrt(max(0, ht_m(:) - hb));
